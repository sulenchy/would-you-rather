...
import { selectAllQuestions, selectQuestionById,selectUsersWithMinInfo, selectAuthedUser, groupQuestionById } from "../selectors";
  ...
  return (
    <div className="w-1/2 flex flex-col mx-auto border-gray-100 border-2">
      <div className="overflow-hidden border-red-100 bg-blue-100">
        <button ref={ tabRef } className="w-1/2 h-16 tablinks border-none outline-none cursor-pointer bg-gray-400 hover:bg-gray-600 focus:bg-green-200" onClick={ event => openTab(event, "unanswered_questions") }>Unanswered Question</button>
